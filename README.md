...
1. Git clone ````https://github.com/Dimushok1221/lab6````
...
* Запустив приложение вы увидите главный экран и кнопку, нажав на нее открывается диалоговое окно с полями ввода:
